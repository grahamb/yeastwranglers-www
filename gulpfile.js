// generated on 2016-11-03 using generator-jekyllized 1.0.0-rc.7
'use strict';
...
gulp.task('assets', gulp.series(
  gulp.parallel('styles', 'scripts', 'fonts', 'images', 'documents'),
...
gulp.task('cleanbuildcopy', gulp.series('build', 'copy:assets'));
